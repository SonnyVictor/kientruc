...
import com.sad.bus.search.bussearchservice.BusSearchService;
...
public class BusSearchController {
	...
	public BookingTicket getTicket(@PathVariable final int id) {
		...
		// get list of available images 
		List<Object> ticketFuta = 	bussearchservice.callFuta();
		if(ticketFuta.size()>0) 
			ticketBus.addAll(ticketFuta);
		List<Object> ticketVexere = bussearchservice.callVexere();
		if(ticketVexere.size()>0) 
